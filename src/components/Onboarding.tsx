    ...
    const handleInputSubmit = async (e?: React.FormEvent) => {
        ...
        if (spark.trim() && !isAnalyzing && !isLoading) {
            ...
            try {
                ...
                setChapterCount(Number(analysis.recommendedChapters) || 5); // Ensure it's a number with fallback
                    ...
                    <div className="text-center space-y-8 animate-in fade-in duration-500 max-w-2xl mx-auto">
                        ...
                        <form onSubmit={handleInputSubmit} className="w-full relative group">
                            <input
                                ...
                                className="w-full bg-transparent border-b-2 border-dark-border focus:border-cobalt outline-none py-4 px-2 text-xl md:text-2xl font-serif text-white placeholder-zinc-600 transition-all duration-300 text-center"
                                autoFocus
